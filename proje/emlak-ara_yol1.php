			...
			<div class="col-md-9">
				...
				<div class="row">
					<ul id="listingLoadMoreWrapper" class="properties-listing sort-destination p-none" data-total-pages="2">
						...
						$emlaksor=$db->prepare("select * from emlak where emlak_durum=:emlak_durum");
						...
						while($emlakcek=$emlaksor->fetch(PDO::FETCH_ASSOC)) {
							...
							if ($emlakcek['emlak_fiyat']>$_POST['emlak_fiyataz'] and $emlakcek['emlak_fiyat']<$_POST['emlak_fiyatcok']) {
